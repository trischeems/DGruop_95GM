...
public interface IProductionOrderRepository
{
    ...
    /// <summary>Tao don hang moi (DRAFT). Tra ve id.</summary>
    Task<long> InsertAsync(TenantScope scope, CreateProductionOrderRequest req);
    ...
    /// <summary>Ghi/cong phieu giu cho ACTIVE (upsert theo don+NVL+kho).</summary>
    Task UpsertReservationAsync(TenantScope scope, long orderId, long materialId, long warehouseId, decimal take);
